...
| FontScaleBottomSheet | `widgets/font_scale_bottom_sheet.dart` | 색 조합 3개를 1행 3열 버튼으로 보여 주고, `글자 크기` 제목 아래에 성경 구절 미리보기를 둔 뒤 글자 크기 3단계 버튼을 배치하는 바텀시트 + `showFontScaleSheet` 헬퍼 |
