#!/usr/bin/env python3
"""Tests for the 200 stories SQL seed builder."""

from __future__ import annotations

import unittest

from build_200_stories_seed_sql import NormalizedEvent, render_delete_stale_events_sql
...
class Build200StoriesSeedSqlTests(unittest.TestCase):
