...
void main() {
  Widget harness({AppColorPalette palette = AppColorPalette.classic}) {
    return MaterialApp(
  ...
  testWidgets('블랙 팔레트에서는 지역 카드가 어두운 표면과 밝은 글자를 사용한다', (tester) async {
    await tester.pumpWidget(harness(palette: AppColorPalette.blackMap));
    ...
    final materials = tester
        ...
        .toList();
    final title = tester.widget<Text>(find.text('북이스라엘'));
